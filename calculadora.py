...
tk.Label(janela, text="Número 1:", bg="white", font=("Arial", 12)).pack(pady=5)
entrada1 = tk.Entry(janela, font=("Arial", 14))
entrada1.pack()

tk.Label(janela, text="Número 2:", bg="white", font=("Arial", 12)).pack(pady=5)
...
tk.Button(frame_botoes, text="Zerar", command=zerar, width=10, font=("Arial", 12)).grid(row=1, column=0, columnspan=4, pady=10)
